        ...
        <div class="container">
                ...
                <aside id="text-10" class="widget widget_text">
                    <div class="textwidget">
                        ...
                        <p class="flv_center">
                            ...
                            <br>
                            <b><i class="icon-clock"></i> Mon - Fri 8:00am - 6:00pm <span class="tooltip" data-tooltip="we are located in Europe" >(GMT +1)</span> </b>
                        </p>
                    </div>
                </aside>
            </div>
            <div class="one-fourth column">
                ...
                <aside id="text-11" class="widget widget_text">
                    <div class="textwidget">
                        <h5 class="flv_margin_b_5"><i class="icon-mail-line"></i> Our address:</h5>
                        <p class="flv_margin_l_26">
                            <strong>Envato</strong>
                            <br> Level 13, 2 Elizabeth St,
                            <br> Melbourne, Victoria 3000 Australia
                        </p>
                        <h5 class="flv_margin_b_5"><i class="icon-phone"></i> Have any questions?</h5>
                        <p class="flv_margin_l_26">
                            <a href="mailto:noreply@envato.com">noreply@envato.com</a>
                        </p>
                        <h5 class="flv_margin_b_5"><i class="icon-comment-line"></i> Call us:</h5>
                        <p class="flv_margin_l_26">
...
<div id="Wrapper">
    <!-- Header Wrapper -->
    <div id="Header_wrapper" class="flv_header_origami">
        <!-- Header -->
        <header id="Header">
                        ...
                        <div class="top_bar_right">
                            <div class="top_bar_right_wrapper">
                                ...
                                <div class="wpml-languages disabled">
                                    <a class="active tooltip" href="blog-full-classic.html" data-tooltip="No translations available for this page"><img src="images/flags/en.png" alt="English" />
                                    </a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="column one">
                    ...
                    <ul class="breadcrumbs">
                        ...
                        <li>
                            <a href="blog-full-classic.html">Blog</a>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="section_wrapper clearfix">
                        ...
                        <div id="Filters" class="column one ">
                            <ul class="filters_buttons">
                                ...
                                <li class="reset">
                                    <a class="close" data-rel="*" href="blog-full-classic.html"><i class="icon-cancel"></i>Show all</a>
                                </li>
                            </ul>
                            <div class="filters_wrapper">
                                <ul class="categories">
                                    <li>
                                        <a data-rel=".category-lifestyle" href="category-page.html">Lifestyle</a>
                                    </li>
                                    <li>
                                        <a data-rel=".category-mobile" href="category-page.html">Mobile</a>
                                    </li>
                                    <li>
                                        <a data-rel=".category-motion" href="category-page.html">Motion</a>
                                    </li>
                                    <li>
                                        <a data-rel=".category-news" href="category-page.html">News</a>
                                    </li>
                                    <li>
                                        <a data-rel=".category-photography" href="category-page.html">Photography</a>
                                    </li>
                                    <li>
                                        <a data-rel=".category-priest" href="category-page.html">Priest</a>
                                    </li>
                                    <li>
                                        <a data-rel=".category-sport" href="category-page.html">Sport</a>
                                    </li>
                                    <li>
                                        <a data-rel=".category-technology" href="category-page.html">Technology</a>
                                    </li>
                                    <li>
                                        <a data-rel=".category-uncategorized" href="category-page.html">Uncategorized</a>
                                    </li>
                                    <li class="close">
                                ...
                                <ul class="tags">
                                    <li>
                                        <a data-rel=".tag-css3" href="tag-page.html">css3</a>
                                    </li>
                                    <li>
                                        <a data-rel=".tag-design" href="tag-page.html">design</a>
                                    </li>
                                    <li>
                                        <a data-rel=".tag-eclipse" href="tag-page.html">eclipse</a>
                                    </li>
                                    <li>
                                        <a data-rel=".tag-framework" href="tag-page.html">framework</a>
                                    </li>
                                    <li>
                                        <a data-rel=".tag-grid" href="tag-page.html">grid</a>
                                    </li>
                                    <li>
                                        <a data-rel=".tag-html5" href="tag-page.html">html5</a>
                                    </li>
                                    <li>
                                        <a data-rel=".tag-mysql" href="tag-page.html">mysql</a>
                                    </li>
                                    <li>
                                        <a data-rel=".tag-themeforest" href="tag-page.html">themeforest</a>
                                    </li>
                                    <li>
                                        <a data-rel=".tag-wordpress" href="tag-page.html">wordpress</a>
                                    </li>
                                    <li>
                                        <a data-rel=".tag-zend" href="tag-page.html">zend</a>
                                    </li>
                                    <li class="close">
                                        <a href="#"><i class="icon-cancel"></i></a>
                                    </li>
                                ...
                                <ul class="authors">
                                    ...
                                    <li>
                                        <a data-rel=".author-milord" href="#">Milord</a>
                                    </li>
                                    <li class="close">
                                        <a href="#"><i class="icon-cancel"></i></a>
                                    </li>
                            ...
                            <div class="blog_wrapper isotope_wrapper">
                                <div class="posts_group lm_wrapper classic">
                                            ...
                                            <div class="post-desc">
                                                <div class="post-meta clearfix">
                                                    <div class="author-date">
                                                            <span class="author"><span>Published by </span><i class="icon-user"></i> <a href="#">Muffin Group</a>
                                                            </span><span class="date"><span> at </span><i class="icon-clock"></i> May 13, 2015</span>
                                                    </div>
                                                    <div class="category">
                                                        ...
                                                        <div class="cat-wrapper">
                                                            <ul class="post-categories">
                                                                <li>
                                                                    <a href="category-page.html" rel="category tag">Motion</a>
                                                                </li>
                                                                <li>
                                                                    <a href="category-page.html" rel="category tag">Photography</a>
                                                                </li>
                                                                <li>
                                                                    <a href="category-page.html" rel="category tag">Uncategorized</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="post-title">
                                                    <h2 class="entry-title"><a href="blog-single-content-builder.html">Content builder for posts</a></h2>
                                                </div>
                                                ...
                                                <div class="post-footer">
                                                    <div class="button-love">
                                                        <span class="love-text">Do you like it?</span><a href="#" class="mfn-love " data-id="175"><span class="icons-wrapper"><i class="icon-heart-empty-fa"></i><i class="icon-heart-fa"></i></span><span class="label">343</span></a>
                                                    </div>
                                                    <div class="post-links">
                                                        <i class="icon-comment-empty-fa"></i><a href="blog-single-content-builder.html#comments" class="post-comments">4</a><i class="icon-doc-text"></i><a href="blog-single-content-builder.html" class="post-more">Read more</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="post-186 post  format-image has-post-thumbnail  category-mobile category-photography category-uncategorized tag-design tag-html5  post-item isotope-item clearfix">
                                        <div class="date_label">
                                            May 13, 2014
                                        </div>
                                        <div class="image_frame post-photo-wrapper scale-with-grid">
                                            <div class="image_wrapper">
                                                <a href="blog-single-vertical-photo.html">
                                                    <div class="mask"></div><img width="500" height="649" src="images/blog_vertical.jpg" class="scale-with-grid wp-post-image" alt="blog_vertical" />
                                                </a>
                                                <div class="image_links double">
                                                    <a href="images/blog_vertical.jpg" class="zoom" rel="prettyphoto"><i class="icon-search"></i></a><a href="blog-single-vertical-photo.html" class="link"><i class="icon-link"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="post-desc-wrapper">
                                            <div class="post-desc">
                                                <div class="post-meta clearfix">
                                                    ...
                                                    <div class="category">
                                                        ...
                                                        <div class="cat-wrapper">
                                                            <ul class="post-categories">
                                                                <li>
                                                                    <a href="category-page.html" rel="category tag">Mobile</a>
                                                                </li>
                                                                <li>
                                                                    <a href="category-page.html" rel="category tag">Photography</a>
                                                                </li>
                                                ...
                                                <div class="post-title">
                                                    <h2 class="entry-title"><a href="blog-single-vertical-photo.html">Post with vertical photo</a></h2>
                                                </div>
                                                <div class="post-excerpt">
                                                ...
                                                <div class="post-footer">
                                                    <div class="button-love">
                                                        <span class="love-text">Do you like it?</span><a href="#" class="mfn-love " data-id="186"><span class="icons-wrapper"><i class="icon-heart-empty-fa"></i><i class="icon-heart-fa"></i></span><span class="label">151</span></a>
                                                    </div>
                                                    <div class="post-links">
                                                        <i class="icon-comment-empty-fa"></i><a href="blog-single-vertical-photo.html#comments" class="post-comments">0</a><i class="icon-doc-text"></i><a href="blog-single-vertical-photo.html" class="post-more">Read more</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="post-190 post  format-quote  category-uncategorized tag-css3 tag-design  post-item isotope-item clearfix no-img">
                                        <div class="date_label">
                                            May 13, 2014
                                        </div>
                                        <div class="image_frame post-photo-wrapper scale-with-grid">
                                        ...
                                        <div class="post-desc-wrapper">
                                            <div class="post-desc">
                                                ...
                                                <div class="post-title">
                                                    <blockquote>
                                                        <a href="blog-single-video.html">Sed dignissim justo. Suspendisse fermentum erat. Duis consequat tortor. Mauris ut tellus a dolor. Suspendisse nec tellus. Donec quis lacus magna, sollicitudin id, turpis. Mauris in velit vel sollicitudin justo. Proin vitae massa nec cursus magna. Fusce blandit eu, ullamcorper in.</a>
                                                    </blockquote>
                                                </div>
                                                <div class="post-excerpt"></div>
                                                <div class="post-footer">
                                                    <div class="button-love">
                                                        <span class="love-text">Do you like it?</span><a href="#" class="mfn-love " data-id="190"><span class="icons-wrapper"><i class="icon-heart-empty-fa"></i><i class="icon-heart-fa"></i></span><span class="label">39</span></a>
                                                    </div>
                                                    <div class="post-links">
                                                        <i class="icon-comment-empty-fa"></i><a href="blog-single-video.html#comments" class="post-comments">0</a><i class="icon-doc-text"></i><a href="blog-single-video.html" class="post-more">Read more</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="post-193 post  format-standard has-post-thumbnail  category-photography category-uncategorized  tag-mysql tag-zend post-item isotope-item clearfix">
                                        ...
                                        <div class="image_frame post-photo-wrapper scale-with-grid">
                                            <div class="image_wrapper">
                                                <div id="rev_slider_16_2_wrapper" class="rev_slider_wrapper fullwidthbanner-container flv_rev_20">
                                                    <div id="rev_slider_16_2" class="rev_slider fullwidthabanner" data-version="5.0.4.1">
                                                        <ul>
                                                            <li data-index="rs-21" data-transition="slidehorizontal" data-slotamount="7" data-easein="default" data-easeout="default" data-masterspeed="300" data-thumb="images/home_betheme_blog_3-100x50.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide" data-description="">
                                                                <img src="plugins/rs-plugin/assets/images/dummy.png " alt="" width="1200" height="800" data-lazyload="images/home_betheme_blog_3.jpg" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
                                                            </li>
                                                            <li data-index="rs-22" data-transition="slidehorizontal" data-slotamount="7" data-easein="default" data-easeout="default" data-masterspeed="300" data-thumb="images/home_betheme_blog_4-100x50.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide" data-description="">
                                                                <img src="plugins/rs-plugin/assets/images/dummy.png " alt="" width="1200" height="800" data-lazyload="images/home_betheme_blog_4.jpg" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
                                                            </li>
                                                        </ul>
                                        ...
                                        <div class="post-desc-wrapper">
                                            <div class="post-desc">
                                                ...
                                                <div class="post-title">
                                                    <h2 class="entry-title"><a href="blog-single-slideshow.html">Post with slideshow</a></h2>
                                                </div>
                                                <div class="post-excerpt">
                                                    <span class="big">Integer gravida eros ut ante. Proin vulputate in, odio. Donec eleifend velit. Suspendisse eget metus. Proin non mattis vel, ornare quam. Aliquam vitae mauris. Nam eu nunc ut urna. Pellentesque fringilla gravida.</span>
                                                </div>
                                                <div class="post-footer">
                                                    <div class="button-love">
                                                        <span class="love-text">Do you like it?</span><a href="#" class="mfn-love " data-id="193"><span class="icons-wrapper"><i class="icon-heart-empty-fa"></i><i class="icon-heart-fa"></i></span><span class="label">78</span></a>
                                                    </div>
                                                    <div class="post-links">
                                                        <i class="icon-comment-empty-fa"></i><a href="blog-single-slideshow.html#comments" class="post-comments">0</a><i class="icon-doc-text"></i><a href="blog-single-slideshow.html" class="post-more">Read more</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="post-183 post  format-video has-post-thumbnail  category-mobile category-photography category-uncategorized tag-css3  tag-zend post-item isotope-item clearfix">
                                        <div class="date_label">
                                            May 13, 2014
                                        </div>
                                        <div class="image_frame post-photo-wrapper scale-with-grid">
                                            <div class="image_wrapper">
                                                <div id="jp_container_182" class="jp-video mfn-jcontainer">
                                                    <div class="jp-type-single">
                                                        <div id="jquery_jplayer_182" class="jp-jplayer mfn-jplayer" data-m4v="images/Sequence-01_1.mp4" data-img="images/blog_html5-576x399.jpg" data-swf="wp-content/themes/betheme/js/index.html"></div>
                                                        <div class="jp-gui">
                                        ...
                                        <div class="post-desc-wrapper">
                                            <div class="post-desc">
                                                ...
                                                <div class="post-title">
                                                    <h2 class="entry-title"><a href="blog-single-html5-video.html">Post with HTML5 Video</a></h2>
                                                </div>
                                                <div class="post-excerpt">
                                                    <span class="big">Vitae adipiscing turpis. Aenean ligula nibh, molestie id viverra a, dapibus at dolor. In iaculis viverra neque, ac ele molestie id viverra aifend ante lobortis id. In viverra ipsum stie id viverra a.</span>
                                                </div>
                                                <div class="post-footer">
                                                    <div class="button-love">
                                                        <span class="love-text">Do you like it?</span><a href="#" class="mfn-love " data-id="183"><span class="icons-wrapper"><i class="icon-heart-empty-fa"></i><i class="icon-heart-fa"></i></span><span class="label">82</span></a>
                                                    </div>
                                                    <div class="post-links">
                                                        <i class="icon-comment-empty-fa"></i><a href="blog-single-html5-video.html#comments" class="post-comments">0</a><i class="icon-doc-text"></i><a href="blog-single-html5-video.html" class="post-more">Read more</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
